                    ...
                    <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="p-6 bg-white rounded-xl shadow">
                            ...
                            <p className="text-gray-600">
                                Write and publish posts on topics you're
                                passionate about
                            </p>
                        </div>
                        <div className="p-6 bg-white rounded-xl shadow">
                        ...
                        <div className="p-6 bg-white rounded-xl shadow">
                            ...
                            <p className="text-gray-600">
                                Read trending posts from various categories
                            </p>
                        </div>
                    </div>
                </Container>
                ...
                <Container>
                    ...
                    <div>
                        ...
                        {isLoading ? (
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 md:gap-10 transition-all duration-300">
                                {posts.map((post) => (
                                    <div
                                        key={post.$id}
